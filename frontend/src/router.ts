...
const PAGE_RENDERERS = {
  ...
  'reservas-logistica': () => typeof (window as any).renderReservasImportacion === 'function' && (window as any).renderReservasImportacion($('#page-content')),
  'tienda-virtual':   () => {},
  ...
  'copro-facturacion': () => typeof renderPhFacturacionPage === 'function' && renderPhFacturacionPage($('#page-content')),
  'copro-cartera':     () => typeof renderPhCarteraPage     === 'function' && renderPhCarteraPage($('#page-content')),
  'copro-presupuesto': () => typeof renderPhPresupuestoPage === 'function' && renderPhPresupuestoPage($('#page-content')),
  'copro-unidades':    () => typeof renderPhUnidadesPage    === 'function' && renderPhUnidadesPage($('#page-content')),
  'copro-reservas':    () => typeof renderPhReservasPage    === 'function' && renderPhReservasPage($('#page-content')),
  'copro-pqrs':        () => typeof renderPhPqrsPage        === 'function' && renderPhPqrsPage($('#page-content')),
