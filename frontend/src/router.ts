...
const PAGE_TITLES: Record<string, string> = {
  ...
  preliquidaciones:  'Preliquidación & Viabilidad',
  ...
  'mis-rutas':       'Mi Agenda de Rutas',
  'rutas-gestion':   'Control y Planificación de Rutas',
  'rutas-vendedores':'Mi Agenda de Rutas',
...
const PAGE_ICONS: Record<string, string> = {
  ...
  'inventario-stock': 'fa-boxes-stacked',
  'inventario-lotes': 'fa-barcode',
  'inventario-pallets': 'fa-pallet',
  embalaje:            'fa-pallet',
  'inventario-movimientos': 'fa-arrows-rotate',
  'inventario-kardex': 'fa-table-list',
  'inventario-bodegas': 'fa-warehouse',
...
const MODULE_LICENSE: Record<string, string> = {
  ...
  'inventario-lotes': 'inventarios',
  'inventario-pallets': 'logistica',
  'embalaje':           'logistica',
  'inventario-movimientos': 'inventarios',
  'inventario-kardex': 'inventarios',
...
const MODULE_LABELS: Record<string, string> = {
  ...
  'tienda-virtual': 'Tienda Virtual',
  spa:           'Spa Mascotas (Veterinaria y Peluquería Canina)',
  'spa-belleza': 'Spa Belleza Humana (Estética y Peluquería)',
  conciliacion:  'Conciliación Bancaria',
...
const PAGE_RENDERERS: Record<string, (container: HTMLElement) => void> = {
  ...
  'inventario-stock':          (c) => typeof (window as any).renderInventarioSection === 'function' ? (window as any).renderInventarioSection(c, 'stock') : (typeof renderInventario === 'function' && renderInventario(c, 'stock')),
  'inventario-lotes':          (c) => typeof (window as any).renderInventarioSection === 'function' ? (window as any).renderInventarioSection(c, 'lotes') : (typeof renderInventario === 'function' && renderInventario(c, 'lotes')),
  'inventario-pallets':        (c) => typeof (window as any).renderInventarioSection === 'function' ? (window as any).renderInventarioSection(c, 'pallets') : (typeof renderInventario === 'function' && renderInventario(c, 'pallets')),
  embalaje:                    (c) => typeof (window as any).renderInventarioSection === 'function' ? (window as any).renderInventarioSection(c, 'pallets') : (typeof renderInventario === 'function' && renderInventario(c, 'pallets')),
  'inventario-movimientos':    (c) => typeof (window as any).renderInventarioSection === 'function' ? (window as any).renderInventarioSection(c, 'movimientos') : (typeof renderInventario === 'function' && renderInventario(c, 'movimientos')),
  'inventario-kardex':         (c) => typeof (window as any).renderInventarioSection === 'function' ? (window as any).renderInventarioSection(c, 'kardex') : (typeof renderInventario === 'function' && renderInventario(c, 'kardex')),
  'inventario-bodegas':        (c) => typeof (window as any).renderInventarioSection === 'function' ? (window as any).renderInventarioSection(c, 'bodegas') : (typeof renderInventario === 'function' && renderInventario(c, 'bodegas')),
  ...
  preliquidaciones:   (c) => typeof (window as any).renderPreliquidaciones === 'function' && (window as any).renderPreliquidaciones(c),
  ...
  'mis-rutas':        (c) => typeof (window as any).renderMiAgendaRutas === 'function' ? (window as any).renderMiAgendaRutas(c) : (typeof (window as any).renderRutasVisitas === 'function' && (window as any).renderRutasVisitas(c)),
  'rutas-gestion':    (c) => typeof (window as any).renderControlRutasAdmin === 'function' ? (window as any).renderControlRutasAdmin(c) : (typeof (window as any).renderRutasVisitas === 'function' && (window as any).renderRutasVisitas(c)),
  'rutas-vendedores': (c) => typeof (window as any).renderRutasVisitas === 'function' && (window as any).renderRutasVisitas(c),
...
function navigate(page: string, forceReload: boolean = false): void {
  ...
  if (page === 'inventario') page = 'inventario-stock';
  if (page === 'embalaje') page = 'inventario-pallets';
