  ...
  try {
    ...
    const inmoProperties = new Collection({
      ...
      fields: [
        ...
        { name: 'social_stratum',  type: 'number',   required: false, min: 1, max: 6 },
        { name: 'area_sqm',        type: 'number',   required: false, min: 0 },
        { name: 'rooms',           type: 'number',   required: false, min: 0 },
        { name: 'bathrooms',       type: 'number',   required: false, min: 0 },
        { name: 'parking_spaces',  type: 'number',   required: false, min: 0 },
        { name: 'admon_price',     type: 'number',   required: false, min: 0 },
        { name: 'year_built',      type: 'number',   required: false, min: 1800 },
        { name: 'has_elevator',    type: 'bool',     required: false },
        { name: 'has_pool',        type: 'bool',     required: false },
        { name: 'has_gym',         type: 'bool',     required: false },
        { name: 'has_balcony',     type: 'bool',     required: false },
        { name: 'has_storage',     type: 'bool',     required: false },
