...
`+t],{type:"text/csv;charset=utf-8;"}),o=URL.createObjectURL(a),s=document.createElement("a");s.href=o,s.download="plantilla_unidades_copropiedades.csv",s.click(),URL.revokeObjectURL(o)}function $i(e,t,a){var h,y;const o=ve(e,["codigo","code","unidad","unit_code"]),s=ve(e,["nombre","name","descripcion"]),i=ve(e,["tipo","unit_type","tipo_unidad"])||"APARTAMENTO",n=ve(e,["torre","tower"]),r=ve(e,["apartamento","apto","apartment"]),c=Pt(ve(e,["coef_participacion","coef","coeficiente"])),l=Pt(ve(e,["cuota_admin","admin_fee","cuota_administracion"])),p=Pt(ve(e,["area_m2","area"])),b=ve(e,["doc_propietario","owner_doc","documento_propietario"]),f=ve(e,["tipo_doc_propietario","owner_doc_type","doc_type_propietario"]).toUpperCase(),d=ve(e,["activo","active","estado"]),m=ve(e,["notas","nota","notes"]);if(!o)return{ok:!1,error:"Falta el código de la unidad"};if(!s)return{ok:!1,error:`Falta el nombre para la unidad ${o}`};const u=new Set(["APARTAMENTO","PARQUEADERO","DEPOSITO","LOCAL","CASA","OFICINA","OTRO"]),_=String(i).toUpperCase();if(!u.has(_))return{ok:!1,error:`Tipo inválido en ${o}: ${i}`};if(c<0||c>100)return{ok:!1,error:`Coeficiente fuera de rango (0-100) en ${o}`};if(l<0)return{ok:!1,error:`Cuota administración negativa en ${o}`};if(p<0)return{ok:!1,error:`Área negativa en ${o}`};let v=null;if(b){const A=Ft(b);if(f&&(v=((h=a.get(`${f}|${A}`))==null?void 0:h.id)||null),v||(v=((y=t.get(A))==null?void 0:y.id)||null),!v)return{ok:!1,error:`No existe tercero propietario con documento ${b}`}}const g=!/^(no|0|false|inactiva|inactivo)$/i.test(d);return{ok:!0,payload:{code:o,name:s,unit_type:_,tower:n,apartment:r,coef_participacion:c,admin_fee:l,area_m2:p,owner_id:v,notes:m,active:g}}}async function wi(){var p,b,f;if(!can("canWrite"))return showToast("No tienes permisos para importar unidades","error");if(Tt)return showToast("Importación en curso, espera...","warning");Ht('<i class="fas fa-building-user mr-2" style="color:#0E7490"></i>Importar Unidades Copropiedades',`
    ...
    ${e.map(a=>`
     ...
     <button class="btn btn-primary" id="pic-save-btn"><i class="fas fa-save mr-1"></i>${o?"Actualizar":"Crear"}</button>`),setTimeout(()=>{var r;(r=document.getElementById("pic-save-btn"))==null||r.addEventListener("click",async()=>{var u,_,v,g,h,y,A;const c=(((u=document.getElementById("pic-code"))==null?void 0:u.value)||"").trim().toUpperCase(),l=(((_=document.getElementById("pic-name"))==null?void 0:_.value)||"").trim(),p=(((v=document.getElementById("pic-desc"))==null?void 0:v.value)||"").trim(),b=parseFloat(((g=document.getElementById("pic-amount"))==null?void 0:g.value)||0)||0,f=((h=document.getElementById("pic-active"))==null?void 0:h.value)!=="false",d=(((y=document.getElementById("pic-account"))==null?void 0:y.value)||"").trim();if(!l||!c){showToast("El código y el nombre son obligatorios.","warning");return}const m=document.getElementById("pic-save-btn");m&&(m.disabled=!0,m.textContent="Guardando...");try{const I=(o==null?void 0:o.property_id)||((A=i==null?void 0:i[0])==null?void 0:A.id)||null,F={code:c||"GEN",name:l,description:p||l,amount:b||0,active:f,account_code:d||null,period:(o==null?void 0:o.period)||_t(),notes:lr((o==null?void 0:o.notes)||"",d),property_id:I};o?(await pb.update("ph_individual_charges",o.id,F),showToast("Concepto actualizado.","success")):(await pb.create("ph_individual_charges",F),showToast("Concepto creado. Disponible para añadir a facturas en borrador.","success")),closeModal(),et(t)}catch(I){showToast(I.message||"Error al guardar. Si persiste, reinicia el servidor para aplicar la migración.","error"),m&&(m.disabled=!1,m.textContent=o?"Actualizar":"Crear")}},{once:!0})},50)}window.postPhInvoiceConfirm=Xi;window.renderPhIndividualConceptRows=cr;window.PH_UNIT_TYPES=zi;window.renderPhConfig=et;window.attachPhInvActions=ot;window.PH_PQRS_STATUS=na;window.phKpi=Se;window.attachPhPqrActions=wo;window.openPhPostPeriodModal=Wi;window.getIndividualConceptAccountCode=Ka;window.voidPhInvoiceModal=ar;window.openPhEditDraftLineModal=Qi;window.renderPhFacturacion=va;window.renderPhUnitRows=sr;window.removePhDraftLineConfirm=Zi;window.renderPhAreasList=rr;window.renderCopropiedades=ll;window.openPhAreaModal=Eo;window.openPhResModal=ir;window.openPhIndividualConceptModal=To;window.openPhUnpostPeriodModal=Yi;window.openPhConceptModal=Co;window.openPhDeletePeriodModal=Ji;window.upsertIndividualConceptAccInNotes=lr;window.openPhGenerateModal=Ki;window.attachPhResActions=Ao;window.openPhPqrModal=ws;window.renderPhPqrs=$s;window.PH_RES_STATUS=yo;window.renderPhCartera=or;window.renderPhPqrRows=$o;window.openPhAddIndividualLinesModal=pr;window.PH_STATUS=ft;window.renderPhReservas=ca;window.PH_PQRS_TYPES=ra;window.markPhPaidConfirm=er;window.openPhUnitModal=_o;window.fmtPeriod=Qe;window.openPhInvoiceDetail=Ya;window.renderPhInvRows=La;window.renderPhUnidades=Ja;window.PH_PQRS_PRIORITY=ia;window.renderPhConceptRows=dr;window.renderPhResRows=xo;window.currentPeriod=_t;window.unpostPhInvoiceConfirm=tr;window._renderPhPage=qi;window.togglePhUnit=nr;const Fe=()=>window.pb,xe=e=>window.fmt?window.fmt(e):`$${Number(e).toLocaleString("es-CO")}`,ae=e=>window.esc?window.esc(e):String(e||"").replace(/</g,"&lt;").replace(/>/g,"&gt;"),Es=(e,t,a,o)=>window.openModal(e,t,a,o),ur=()=>window.closeModal(),Te=(e,t)=>window.showToast(e,t);let la=[];function Ts(e){return`${e.doc_number||""} — ${e.name||""}`.trim()}function mr(e,t,a,o,s,i){const n=document.getElementById(e),r=document.getElementById(t),c=document.getElementById(a),l=document.getElementById(o);if(!n||!r||!c||!l)return;const p=la.filter(s),b=(m="")=>{const u=m.toLowerCase().split(/\s+/).filter(Boolean),_=u.length?p.filter(v=>{const g=`${v.doc_number||""} ${v.name||""}`.toLowerCase();return u.every(h=>g.includes(h))}).slice(0,50):p.slice(0,50);if(!_.length){l.innerHTML='<div class="px-3 py-2 text-xs text-gray-500">Sin resultados</div>';return}l.innerHTML=_.map(v=>`<button type="button" data-teso-id="${v.id}" class="w-full text-left px-3 py-2 text-sm hover:bg-blue-50 bg-white border-none cursor-pointer text-gray-800">
      ...
      </button>`}).join("")};(()=>{const f=It.find(d=>d.id===r.value);n.value=f?`${f.code} - ${f.name}`:""})(),n.onfocus=()=>{l(n.value),c.style.display="block"},n.oninput=()=>{r.value="",l(n.value),c.style.display="block"},c.onclick=f=>{const d=f.target.closest("[data-teso-id]");if(!d)return;const m=d.dataset.tesoId||"",u=It.find(_=>_.id===m)||null;r.value=m,n.value=u?`${u.code} - ${u.name}`:"",c.style.display="none",u&&s(u)};const b=f=>{i.contains(f.target)||(c.style.display="none")};setTimeout(()=>document.addEventListener("click",b),0)}window._changeTesoOrigen=async e=>{Cs=e,Fa=null,Pe=null,Ie=[];const t=document.getElementById("teso-lbl-tercero"),a=document.getElementById("modal-rc-search"),o=document.getElementById("modal-rc-hidden"),s=document.getElementById("modal-rc-results"),i=document.getElementById("teso-modal-items-container");a&&(a.value="",a.oninput=null,a.onfocus=null),o&&(o.value=""),s&&(s.style.display="none",s.onclick=null),i&&(i.innerHTML=`
