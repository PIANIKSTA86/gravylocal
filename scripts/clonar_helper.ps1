...
$include = @(
    ...
    'start-cloud.bat',
    'start-silent-cloud.vbs',
    'setup-cloudflare.bat',
    'scripts\setup-cloudflare-tunnel.ps1',
    'install-pm2-service.bat',
    'scripts\install-pm2-service.ps1',
    'ecosystem.config.js',
    'config',
    'DOCUMENTACION_CLOUDFLARE_TUNNEL.md',
    'start.bat',
    'instalar.bat',
    'clonar.bat',
    'scripts\clonar_helper.ps1',
    'respaldo-maestro.bat',
    'restaurar.bat',
    'scripts\sqlite_checkpoint.js',
    'scripts\generar_respaldo_maestro.ps1',
    'scripts\restaurar_respaldo.ps1',
    'scripts\remapear_puertos.js',
    'update-patch.bat',
    'reset.ps1',
